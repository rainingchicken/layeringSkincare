...
11. I fixed the mobile page a little. The problem was that the references contained url that is too long and for some reason did not wrap properly. I added word-wrap:break word to force url to fit container and it worked out and the headings and nav hide and unhide depending on scrolling also works well now.
